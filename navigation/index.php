    ...
    <div class="navBar">
        <ul class="navbar_wrapper-items">
            ...
            <li class="navbar_item">
                <a class="item_link" href="">Отзывы</a>
            </li>
            <li class="navbar_item">
                <a class="item_link" href="">Контакты</a>
            </li>
            <li class="navbar_item">
                <a class="item_link link-orange" href="mailto:reformaopt@yandex.ru">reformaopt@yandex.ru</a>
            </li>
            <li class="navbar_item">
                <a class="item_link link-orange" href="tel:+73433020700">+7 (343) 302-07-00</a>
            </li>
        </ul>
